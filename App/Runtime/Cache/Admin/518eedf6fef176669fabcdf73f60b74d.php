    ...
    <form class="form form-horizontal" action="<?php echo U('More/setup');?>" method="post" onsubmit="return ac_from();"  enctype="multipart/form-data">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-3">
                ...
                <!-- <iframe class="pro_2" src="/minipetmrschool/Data/inc/photo_add.php?id=photo_sj0&width=200&height=200" frameborder="0"></iframe> -->
                <?php if ($info['logo']) { ?>
                <img src="/minipetmrschool/Data/<?php echo $info['logo']; ?>" width="100" height="100" /><br /><br />
                <?php } ?>
